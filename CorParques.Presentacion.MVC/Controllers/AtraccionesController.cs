...
{
    public class AtraccionesController : ControladorBase
    {
        public async Task<ActionResult> Index()
        {
            var lista = await GetAsync<IEnumerable<Puntos>>($"Puntos/GetAllxTipoPunto/{(int)Enumerador.TiposPuntos.Atraccion}");
            return View(lista);
        }
        ...
        public async Task<ActionResult> Update(Puntos modelo)
        {
            ...
            modelo.IdTipoPunto = ((int)Enumerador.TiposPuntos.Atraccion) ;
