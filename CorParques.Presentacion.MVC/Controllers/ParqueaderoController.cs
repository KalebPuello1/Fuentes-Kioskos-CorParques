...
namespace CorParques.Presentacion.MVC.Controllers
{
    public class ParqueaderoController : ControladorBase
    {
        ...
        {
            var lista = await GetAsync<IEnumerable<Puntos>>($"Puntos/GetAllxTipoPunto/{(int)Enumerador.TiposPuntos.Parqueadero}");
            return View(lista);
        }
        ...
        public async Task<ActionResult> Update(Puntos modelo)
        {
            ...
            modelo.IdTipoPunto = (int)Enumerador.TiposPuntos.Parqueadero;
