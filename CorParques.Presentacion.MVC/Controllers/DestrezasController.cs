...
namespace CorParques.Presentacion.MVC.Controllers
{
    public class DestrezasController : ControladorBase
    {
        ...
        {
            var lista = await GetAsync<IEnumerable<Puntos>>($"Puntos/GetAllxTipoPunto/{(int)Enumerador.TiposPuntos.Destreza}");
            return View(lista);
        }
        ...
        public async Task<ActionResult> Insert(Puntos modelo)
        {
            ...
            modelo.IdTipoPunto = (int)Transversales.Util.Enumerador.TiposPuntos.Destreza;
        ...
        public async Task<ActionResult> Update(Puntos modelo)
        {
            ...
            modelo.IdTipoPunto = (int)Enumerador.TiposPuntos.Destreza;
        ...
        public async Task<ActionResult> Delete(int id)
        {
            ...
            return Json(new RespuestaViewModel { Correcto = false, Mensaje = "Se presento un error eliminando la destreza. Por favor intentelo de nuevo" });
        }
        ...
        private string moveFile(string name, string newName)
        {
            ...
            var pathDest = Path.Combine(Server.MapPath("~/Images/Destrezas/"), newFile);
