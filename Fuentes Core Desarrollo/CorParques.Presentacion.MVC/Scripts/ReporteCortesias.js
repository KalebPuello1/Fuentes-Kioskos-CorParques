...
$(function () {
    ...
    $("#btnBuscar").click(function () {
        //if (validarFormulario("frmBusqueda")) {            
            ...
            objeto.fechaFinal = $("#txtFechaFinal").val();
            objeto.documento = $("#txtDocumento").val();
            objeto.tarjetaFan = $("#txtTarjetaFan").val();
            EjecutarAjax(urlBase + "ReporteCortesias/ObtenerDatosReporte", "GET", objeto, "GenerarReporte", null);
        //}        
