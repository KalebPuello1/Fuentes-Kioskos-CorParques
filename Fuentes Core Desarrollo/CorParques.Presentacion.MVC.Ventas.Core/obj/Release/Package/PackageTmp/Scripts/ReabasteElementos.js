...
$(function () {
    ...
    $("#btnSaveAgergarElemento").click(function () {
        ...
        if (validarFormulario("formAgergarElemento *")) {
            ...
            if (existeCodigoBarras) {
                ...
                objElemento.Id = -1;
                objElemento.EsReabastecimiento = true;
    ...
    $("#btnEnviarAperturaElemento").click(function () {
        ...
        if (isValidForm) {
            MostrarConfirm("Importante!", "¿Está seguro de guardar el reabastecimiento?", "ConfirmEnviarApertura", null);
...
function ConfirmEnviarApertura() {
    EjecutarAjax(urlBase + "Reabastecimiento/InsertElementos", "POST", JSON.stringify({ Elementos: listaElementos, IdPunto: $("#selectPuntoAgergarElemento").val() }), "SuccessbtnEnviarAperturaElemento", null);
}
...
function CargarDatosAperturaElementos() {
    ...
    if ($("#selectPuntoAgergarElemento").val() != "") {
        EjecutarAjax(urlBase + "Reabastecimiento/ElementosPorIdPunto", "POST", JSON.stringify({ IdPunto: $("#selectPuntoAgergarElemento").val() }), "SuccessObtenerElementosPorIdPunto", null);
    } else {
        listaElementos = [];
        listaElementosConsultados = [];
        listaElementosToTable();
