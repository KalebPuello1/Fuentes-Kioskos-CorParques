            ...
            createButton = function (obj, button) {
                ...
                switch (typeof button) {
                    ...
                    case 'string':
                        switch (button) {
                            case 'capslock':
                                character = '<span><i class="fa fa-arrow-up my-2" aria-hidden="true"></i></span>';
                                type = 'capslock';
                                break;

                            case 'shift':
                                character = '<span>?123</span>';
                                type = 'shift';
                                break;
                            ...
                            case 'delete':
                                character = '<span><i class="fa fa-arrow-left my-2" aria-hidden="true"></i></span>';
                                type = 'delete';
                                break;
