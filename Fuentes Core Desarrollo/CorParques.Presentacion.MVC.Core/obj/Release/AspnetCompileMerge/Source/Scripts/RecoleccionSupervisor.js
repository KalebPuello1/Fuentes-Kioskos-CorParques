...
var contador = 0;
var tabs = [];
var objetorecolecciones = [];

$(function () {
    if ($("#IdUsuarioCreacion").val() !== "")
    {
        $("#ddlTaquillero").val($("#IdUsuarioCreacion").val())
    }
    asignarSelect2();
    if (!PostBackGuardar()) {
        return false;
...
function Inicializar() {
    ...
    $("#btnValidarClave").click(function () {
        ...
        var observacion = $('#ObservacionTaquillero').val();
    ...
    $(".paso").click(function () {
        ...
        document.location = urlBase + "RecoleccionSupervisor/ObtenerDatosRecoleccion?Id=" + IdUsuarioCreacion + "&Usuario=" + Usuario + "&IdRecoleccion=" + id;
        //EjecutarAjax(urlBase + "RecoleccionSupervisor/ObtenerDatosRecoleccion", "GET", { Id: IdUsuarioCreacion, Usuario: Usuario, IdRecoleccion : id}, "printPartial", { div: "#listView", func: "setEventEdit" });
    });
...
function OnChangeEvent(dropDownElement) {
    ...
    document.location = urlBase + "RecoleccionSupervisor/ObtenerDatosRecoleccion?Id=" + selectedValue + "&Usuario=" + usuario + "&IdRecoleccion=0";
    //EjecutarAjax(urlBase + "RecoleccionSupervisor/ObtenerDatosRecoleccion", "GET", { Id: selectedValue, Usuario: usuario, IdRecoleccion: 0 }, "printPartial", { div: "#listView", func: "setEventEdit" });
}
...
function CancelLogin() {
    ...
    $('#ObservacionTaquillero').val("");
    $('#ObservacionSupervisor').val("");
    MostrarMensajeRedireccion("Importante", "Desea cancelar la recolección", "RecoleccionSupervisor/Index", "success");
}
...
function printPartialRecoleccion(data, values) {
